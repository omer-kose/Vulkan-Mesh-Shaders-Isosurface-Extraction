...
VkPipeline MarchingCubesIndirectPass::Pipeline = VK_NULL_HANDLE;
VkPipelineLayout MarchingCubesIndirectPass::PipelineLayout = VK_NULL_HANDLE;
...
void MarchingCubesIndirectPass::Execute(VulkanEngine* engine, VkCommandBuffer cmd)
{
...
void MarchingCubesIndirectPass::UpdateMCSettings(const MCSettings& mcSettings)
{
...
{
    PushConstants.chunkMetadataBufferAddress = chunkDrawDataBufferAddress;
